...
if($vhi==""){
	...
	$bl=substr($vdf,5,2);
	$tg=substr($vdf,8,2);
	$sql="select logdtm,trafficin from  mrtg where (ip='".$hi."' or host='".$hi."') and logdtm between '".$vdf." 00:00:00' and '".$vdt." 23:59:59' order by logdtm";
$sql="select concat(checkdt,' ',checkhr,':00:00'),trafficin/1024 from hourly_h where (host='".$vhi."') and checkdt between '".$vdf." 00:00:00' and '".$vdt." 23:59:59' order by checkdt,checkhr";
$sql="select concat(checkdt,' ',checkhr,':00:00'),ping_result from hourly_h where (host='".$vhi."') and checkdt between '".$vdf." 00:00:00' and '".$vdt." 23:59:59' order by checkdt,checkhr";
...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <title><?php echo $c_site_title;?> - PING HOST</title>
...
$('#xopo').load('host_mrtg.php?hi=<?php echo $vhi; ?>&df=<?php echo $vdf; ?>&dt=<?php echo $vdt; ?>');
...
?> 
 ...
 <div><h4>Ping Latency (ms)</h4></div>
			...
			<form class="uk-form">
				...
				Ping Host <br />
				<input type="text" name="hi" id="hi" value="<?php echo $vhi ?>">
				</div>
				<div class="uk-grid-1-3">
				From <br />
