...
$tablename="kodam";
$key="kodamid";
$columns="kodamid,kodamname,`left`,`top`";
...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <title><?php echo $c_site_title;?> - Master Data - Map Kodam</title>
...
<div><h3>Map Kodam<h3></div>			

<hr class="uk-grid-divider">

<form class="uk-form" method="post" action="md_kodam_save.php">
<input type="hidden" name="sv" value="EDIT">
    <fieldset data-uk-margin>
		<input type="hidden" name="kodamid" value="<?php echo $row[0]; ?>">
		Kodam : <input type="text" name="kodamname" placeholder="Kodam" value="<?php echo $row[1]; ?>"><br /><br />
