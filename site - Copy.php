...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <title><?php echo $c_site_title;?> - Site</title>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        <div class="uk-width-1-6">
                            <i class="uk-icon-fire uk-icon-large uk-text-primary"></i>
                        </div>
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3"><a href="domain_top.php">Recently Visited Site</a></h2>
                            <p>Website yang sering dikunjungi.</p>
                        </div>
                    </div>
                </div>
 <!--
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Per Kabupaten/Kota</h2>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Per Jaringan</h2>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Per Kelompok Sekolah</h2>
                            <p>Top Bandwidth Usage per Kelompok Sekolah.</p>
                        </div>
                    </div>
                </div>
