...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <title><?php echo $c_site_title;?> - Report</title>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3"><a href="report_onoff.php">On/Off</a></h2>
                            <p>Report On/Off</p>
                        </div>
                    </div>
                </div>
 <!--
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3"><a href="bandwidth_jaringan.php">Per Layanan</a></h2>
                            <p>Top Bandwidth Usage per Layanan.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3"><a href="bandwidth_jnssekolah.php">Per Jaringan</a></h2>
