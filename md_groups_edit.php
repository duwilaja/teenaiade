...
<input type="hidden" name="sv" value="EDIT">
    <fieldset data-uk-margin>
		...
		<input type="text" name="grpid" placeholder="ID" value="<?php echo $row[1]; ?>"><br /><br />
		<input type="text" name="grpname" placeholder="Name" value="<?php echo $row[2]; ?>"><br /><br />
        <input type="text" name="grpgroup" placeholder="Group" value="<?php echo $row[3]; ?>"><br /><br />
