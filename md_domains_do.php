...
$tablename="domains";
$columns="rowid,dname,ip,concat('<a href=\"md_domains_edit.php?id=',rowid,'\">Edit</a>') as edit";
...
$search = "";
if($str!=""){
	$search=" where dname like '%".$str."%' or ip like '%".$str."%' ";
}
...
$sql = "select ".$columns." from ". $tablename ." ".$search." order by dname ".$limit;
//echo $sql;
