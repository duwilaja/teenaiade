...
$columns=$link.",hostname,a.ip,group1,group2,group3,group4,if(b.ping+b.ping2+log1+log2+log3>0,'ON','OFF') as onoff,npsn";
...
$sql = "select ".$columns." from ". $tablename ." where ".$search." order by hostid,checkdt desc ".$limit;
//echo $sql;
